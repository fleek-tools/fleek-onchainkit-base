...
// <stdin>
var proxy = globalThis.__nextOnPagesRoutesIsolation.getProxyFor("/api/[[...route]]");
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
    ...
    async function er(e10) {
      ...
      let n10, s10;
      !function() {
        if (!et && (et = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
    ...
    let ea = 0, eo = "x-vercel-cache-tags", ec = "x-vercel-sc-headers", el = "x-vercel-revalidate", eu = "x-vercel-cache-item-name", eh = !!process.env.NEXT_PRIVATE_DEBUG_CACHE;
    ...
    class ep {
      ...
      constructor(e10) {
        ...
        let t10 = e10._requestHeaders["x-vercel-sc-host"] || process.env.SUSPENSE_CACHE_URL, r10 = e10._requestHeaders["x-vercel-sc-basepath"] || process.env.SUSPENSE_CACHE_BASEPATH;
        if (process.env.SUSPENSE_CACHE_AUTH_TOKEN && (this.headers.Authorization = `Bearer ${process.env.SUSPENSE_CACHE_AUTH_TOKEN}`), t10) {
    ...
    class ey {
      constructor(e10) {
        this.fs = e10.fs, this.flushToDisk = e10.flushToDisk, this.serverDistDir = e10.serverDistDir, this.revalidatedTags = e10.revalidatedTags, this.debug = !!process.env.NEXT_PRIVATE_DEBUG_CACHE, e10.maxMemoryCacheSize ? s || (this.debug && console.log("using memory store for fetch cache"), s = new es.q(e10.maxMemoryCacheSize, function({ value: e11 }) {
          var t10;
          if (!e11)
            return 25;
          if (e11.kind === en.yD.REDIRECT)
    ...
    class eC {
      constructor({ fs: e10, dev: t10, dynamicIO: r10, flushToDisk: n10, fetchCache: s10, minimalMode: i10, serverDistDir: a10, requestHeaders: o10, requestProtocol: c10, maxMemoryCacheSize: l10, getPrerenderManifest: u10, fetchCacheKeyPrefix: h2, CurCacheHandler: d2, allowedRevalidateHeaderKeys: p2 }) {
        ...
        let v2 = !!process.env.NEXT_PRIVATE_DEBUG_CACHE;
        ...
        process.env.__NEXT_TEST_MAX_ISR_CACHE && (l10 = parseInt(process.env.__NEXT_TEST_MAX_ISR_CACHE, 10)), this.dev = t10, this.hasDynamicIO = r10, this.disableForTestmode = "true" === process.env.NEXT_PRIVATE_TEST_PROXY, this.minimalMode = i10, this.requestHeaders = o10, this.requestProtocol = c10, this.allowedRevalidateHeaderKeys = p2, this.prerenderManifest = u10(), this.revalidateTimings = new eE(this.prerenderManifest), this.fetchCacheKeyPrefix = h2;
        let b2 = [];
    ...
    var eW = r(5954), eG = r(4139), eJ = r(3113), eK = (e10) => {
      let t10 = { origin: "*", allowMethods: ["GET", "HEAD", "PUT", "POST", "DELETE", "PATCH"], allowHeaders: [], exposeHeaders: [], ...e10 }, r10 = ((e11) => "string" == typeof e11 ? "*" === e11 ? () => e11 : (t11) => e11 === t11 ? t11 : null : "function" == typeof e11 ? e11 : (t11) => e11.includes(t11) ? t11 : null)(t10.origin);
    ...
    var l = ["strict", "lax", "none"], u = ["low", "medium", "high"], h = class {
      ...
      delete(...e2) {
        ...
        return this.set({ ...r2, name: t2, value: "", expires: new Date(0) });
      }
      [Symbol.for("edge-runtime.inspect.custom")]() {
    ...
    class l {
      ...
      disable() {
        this._mutableCookies.set({ name: c, value: "", httpOnly: true, sameSite: "none", secure: true, path: "/", expires: new Date(0) });
      }
    }
    var u = r(9);
    function h(e2, t2) {
    ...
    function g(e2) {
      ...
      globalThis2.fetch = function(e3, { workAsyncStorage: t3, workUnitAsyncStorage: r2 }) {
        let c2 = async (c3, u2) => {
          ...
          let v = (null == y ? void 0 : y.href) ?? "", w = (null == u2 ? void 0 : null == (f2 = u2.method) ? void 0 : f2.toUpperCase()) || "GET", x = (null == u2 ? void 0 : null == (g2 = u2.next) ? void 0 : g2.internal) === true, b = "1" === process.env.NEXT_OTEL_FETCH_DISABLED, _ = x ? void 0 : performance.timeOrigin + performance.now(), S = t3.getStore(), O = r2.getStore(), E = O && "prerender" === O.type ? O.cacheSignal : null;
          E && E.beginRead();
    ...
    class w {
      ...
      trace(...e2) {
        ...
        if (!s.KK.includes(r2) && "1" !== process.env.NEXT_OTEL_VERBOSE || u2.hideSpan)
          return l2();
        ...
        return u2.attributes = { "next.span_name": d2, "next.span_type": r2, ...u2.attributes }, a.with(g2.setValue(m, w2), () => this.getTracerInstance().startActiveSpan(d2, u2, (e3) => {
          let t3 = "performance" in globalThis2 && "measure" in performance ? globalThis2.performance.now() : void 0, n3 = () => {
            f.delete(w2), t3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && s.EI.includes(r2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(r2.split(".").pop() || "").replace(/[A-Z]/g, (e4) => "-" + e4.toLowerCase())}`, { start: t3, end: performance.now() });
          };
      ...
      wrap(...e2) {
        ...
        return s.KK.includes(r2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
          let e3 = n2;
